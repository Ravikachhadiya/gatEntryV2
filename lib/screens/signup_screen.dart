...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _saveForm() async {
    ...
    try {
      // add New User
      Provider.of<User>(context, listen: false).addNewUser(_newUser);

      // add approval request
      if (_newUser.userType == UserType.Member || _newUser.userType == UserType.SecurityGuard) {
  ...
  void printData() {
    print("Id : " + _newUser.id.toString());
    print("User Type : " + _userType.toString());
    print("Name : " + _name.toString());
    print("Email : " + _email.toString());
    print("city : " + _city.toString());
    print("society : " + _society.toString());
    print("Building : " + _building.toString());
    print("House no : " + _houseNumber.toString());
    print("User Status : " + _userStatus.toString());
    print("Occupancy Status : " + _occupancyStatus.toString());
  }
